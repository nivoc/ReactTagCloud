...
var TagDataAPI = {
  // getAll returns just the topic array. In the real world would 
  // this API handle all the async complexity and optistic updates
  // to keep the store syncron and easy to reason about.
  getAll: function() {
    return _topics;
  }
};
